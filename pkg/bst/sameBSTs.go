...
// from left to right, into the BST. Write a function that takes in two unit_arrays of integers and determines whether these unit_arrays represent the same BST.
